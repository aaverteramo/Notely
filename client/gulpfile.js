// This file is used to scan the app .js files with some excusions and bundles them into one .js file.
...
gulp.task('bundle', function() {
  return gulp.src(javascriptFiles)
    ...
    .pipe(sourcemaps.init()) // Let sourcemap watch what we are doing in this pipeline: maintains details on pre-bundles files.
